...
/* 0x04 */ JT_CASE(0x04) // FD_BPF_OP_ADD_IMM
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] + (uint)instr.imm);
JT_CASE_END
/* 0x05 */ JT_CASE(0x05) // FD_BPF_OP_JA
  pc += instr.offset;
JT_CASE_END
/* 0x07 */ JT_CASE(0x07) // FD_BPF_OP_ADD64_IMM
  register_file[dst_reg] = (ulong)((long)register_file[dst_reg] + (long)instr.imm);
JT_CASE_END
...
/* 0x15 */ JT_CASE(0x15) // FD_BPF_OP_JEQ_IMM
  pc += (register_file[dst_reg] == instr.imm) ? instr.offset : 0;
JT_CASE_END
/* 0x17 */ JT_CASE(0x17) // FD_BPF_OP_SUB64_IMM
  register_file[dst_reg] = (ulong)((long)register_file[dst_reg] - (long)instr.imm);
JT_CASE_END
/* 0x18 */ JT_CASE(0x18) // FD_BPF_OP_LDQ
  register_file[dst_reg] = (ulong)((ulong)instr.imm | ((ulong)ctx->instrs[pc+1].imm << 32));
  pc++;
JT_CASE_END
...
/* 0x34 */ JT_CASE(0x34) // FD_BPF_OP_DIV_IMM
  register_file[dst_reg] = instr.imm == 0 ? 0 : (uint)((uint)register_file[dst_reg] / (uint)instr.imm);
JT_CASE_END
/* 0x35 */ JT_CASE(0x35) // FD_BPF_OP_JGE_IMM
  pc += (register_file[dst_reg] >= instr.imm) ? instr.offset : 0;
JT_CASE_END
/* 0x37 */ JT_CASE(0x37) // FD_BPF_OP_DIV64_IMM
  register_file[dst_reg] = instr.imm == 0 ? 0UL : (ulong)((long)register_file[dst_reg] / (long)instr.imm);
JT_CASE_END
...
/* 0x47 */ JT_CASE(0x47) // FD_BPF_OP_OR64_IMM
  register_file[dst_reg] |= instr.imm;
JT_CASE_END
...
/* 0x62 */ JT_CASE(0x62) // FD_BPF_OP_STW
  cond_fault = fd_vm_mem_map_write_uint( ctx, (ulong)((long)register_file[dst_reg] + instr.offset), (uint)instr.imm );
...
/* 0x65 */ JT_CASE(0x65) // FD_BPF_OP_JSGT_IMM
  pc += ((long)register_file[dst_reg] > (int)instr.imm) ? instr.offset : 0;
JT_CASE_END
...
/* 0x6a */ JT_CASE(0x6a) // FD_BPF_OP_STH
  cond_fault = fd_vm_mem_map_write_ushort( ctx, (ulong)((long)register_file[dst_reg] + instr.offset), (ushort)instr.imm );
...
/* 0x72 */ JT_CASE(0x72) // FD_BPF_OP_STB
  cond_fault = fd_vm_mem_map_write_uchar( ctx, (ulong)((long)register_file[dst_reg] + instr.offset), (uchar)instr.imm );
...
/* 0x75 */ JT_CASE(0x75) // FD_BPF_OP_JSGE_IMM
  pc += ((long)register_file[dst_reg] >= (long)instr.imm) ? instr.offset : 0;
JT_CASE_END
...
/* 0x7a */ JT_CASE(0x7a) // FD_BPF_OP_STQ
  cond_fault = fd_vm_mem_map_write_ulong( ctx, (ulong)((long)register_file[dst_reg] + instr.offset), (ulong)instr.imm );
...
/* 0x87 */ JT_CASE(0x87) // FD_BPF_OP_NEG64
  register_file[dst_reg] = (ulong)(-(long)register_file[dst_reg]);
JT_CASE_END
...
/* 0x94 */ JT_CASE(0x94) // FD_BPF_OP_MOD_IMM
  register_file[dst_reg] = ((uint)instr.imm==0) ? (uint)register_file[dst_reg] : (uint)((uint)register_file[dst_reg] % (uint)instr.imm);
JT_CASE_END
...
/* 0x97 */ JT_CASE(0x97) // FD_BPF_OP_MOD64_IMM
  register_file[dst_reg] = (instr.imm==0) ? register_file[dst_reg] : register_file[dst_reg] % instr.imm;
JT_CASE_END
...
/* 0xb4 */ JT_CASE(0xb4) // FD_BPF_OP_MOV_IMM
  register_file[dst_reg] = (uint)instr.imm;
JT_CASE_END
...
/* 0xc4 */ JT_CASE(0xc4) // FD_BPF_OP_ARSH_IMM
  register_file[dst_reg] = (uint)((int)register_file[dst_reg] >> (uint)instr.imm);
JT_CASE_END
/* 0xc5 */ JT_CASE(0xc5) // FD_BPF_OP_JSLT_IMM
  pc += ((long)register_file[dst_reg] < (long)instr.imm) ? instr.offset : 0;
JT_CASE_END
/* 0xc7 */ JT_CASE(0xc7) // FD_BPF_OP_ARSH64_IMM
  register_file[dst_reg] = (ulong)((long)register_file[dst_reg] >> instr.imm);
JT_CASE_END
...
/* 0xdc */ JT_CASE(0xdc) // FD_BPF_OP_END_BE
  switch (instr.imm) {
    case 16:
      register_file[dst_reg] = (ushort)fd_ushort_bswap((ushort)register_file[dst_reg]);
      register_file[dst_reg] &= 0xFFFF;
      break;
    case 32:
      register_file[dst_reg] = (uint)fd_uint_bswap((uint)register_file[dst_reg]);
      register_file[dst_reg] &= 0xFFFFFFFF;
      break;
    case 64:
      register_file[dst_reg] = (ulong)fd_ulong_bswap((ulong)register_file[dst_reg]);
      break;
  }
JT_CASE_END
