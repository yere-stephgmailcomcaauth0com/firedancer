...
#define FD_EXEC_TEST_PACK_COMPUTE_BUDGET_EFFECTS_INIT_DEFAULT {0, 0, 0, 0}
...
#define FD_EXEC_TEST_PACK_COMPUTE_BUDGET_EFFECTS_INIT_ZERO {0, 0, 0, 0}
...
#define FD_EXEC_TEST_PACK_COMPUTE_BUDGET_EFFECTS_SIZE 34
